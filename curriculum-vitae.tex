...
\DeclareDocumentCommand\cvBulletEntry{ m m d<>}{
    #1 & #2
    \IfValueT {#3} {\vspace{#3}}
    \tabularnewline
}
...
\DeclareDocumentCommand\bulletpoint{ m d<> g d<> }{
    \item #1
        \IfValueTF {#3} {
            ...
            \footnotesize{\color{itemSubtextColor}#3}
